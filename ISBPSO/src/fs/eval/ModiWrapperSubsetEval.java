 ...
 */
public class ModiWrapperSubsetEval extends ASEvaluation
  ...
  public double evaluateSubset(BitSet subset) throws Exception {
    ...
    // copy the instances
    //System.out.println(this.m_trainInstances.numAttributes());
    ...
    for (i = 0; i < 5; i++) {
      ...
      case EVAL_DEFAULT:
        ...
        repError[i] = 1 - obj.fit(1 - repError[i], 
        		trainCopy.numAttributes() - 1, m_numAttribs - 1);
        //System.out.println(repError[i]);
        break;
      case EVAL_ACCURACY:
        repError[i] = m_Evaluation.errorRate();
        repError[i] = 1 - obj.fit(1 - repError[i], 
  ...
  public static void main(String[] args) {
    runEvaluator(new ModiWrapperSubsetEval(), args);
  }
}
